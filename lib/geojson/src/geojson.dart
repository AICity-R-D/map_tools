...
class GeoJSONFeature implements GeoJSON {
  ...
  GeoJSONFeature(
      this.geometry, this.properties, Map<String, dynamic>? foreignMembers,
      [List<String>? keys]) {
  ...
  factory GeoJSONFeature.fromMap(Map<String, dynamic> map) {
    ...
    return GeoJSONFeature(Geometry.fromMap(geometry), properties,
        foreignMembers, map.keys.toList());
  }
  ...
  Map<String, dynamic> get geoJSON {
    Map<String, dynamic> results = {
      ...
      'properties': properties.isNotEmpty? properties : {},
...
class GeoJSONFeatureCollection implements GeoJSON {
  ...
  GeoJSONFeatureCollection(this.features, Map<String, dynamic>? foreignMembers,
      [List<String>? keys]) {
    if (foreignMembers != null && foreignMembers.isNotEmpty) {
      this.foreignMembers.addAll(foreignMembers);
    }
  ...
  Map<String, dynamic> get geoJSON {
    Map<String, dynamic> results = {
      'type': type.rawValue,
      'features': features.isNotEmpty? features.map((e) => e.geoJSON).toList() : [],
      if (_featureKeys.contains('bbox') && boundingBox != null) ...{
        'bbox': boundingBox!.rawValue
      }
    };
...
class GeoJSONGeometryCollection implements GeoJSON {
  ...
  GeoJSONGeometryCollection(
      this.geometries, Map<String, dynamic>? foreignMembers,
      [List<String>? keys]) {
    if (foreignMembers != null && foreignMembers.isNotEmpty) {
      this.foreignMembers.addAll(foreignMembers);
    }
  ...
  Map<String, dynamic> get geoJSON {
    Map<String, dynamic> results = {
      'type': type.rawValue,
      'geometries': geometries.isNotEmpty? geometries.map((e) => e.geoJSON).toList() : [],
      if (_featureKeys.contains('bbox') && boundingBox != null) ...{
       'bbox': boundingBox!.rawValue
      }
    };
